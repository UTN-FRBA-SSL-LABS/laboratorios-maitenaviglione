...
> R:carrito_init pone la cantidad en 0 para inicializar el carrito vacío
...
> R:NO, esperaba 700 y obtuvo 350
...
> R:falló, el quinto carrito_agregar devolvía 1
...
> R:sí, carrito_descuento quedó con ##### porque no fue ejecutada por los tests unitarios de cobertura
...
> R:Un test unitario prueba una función de forma aislada, mientras que un test de integración verifica que varias funciones trabajen correctamente en conjunto. El bug de carrito_total lo detectó primero un test unitario.
...
> R:Es peligroso en C porque se puede escribir fuera de los límites del array y acceder a memoria que no corresponde. En lenguajes como Python o Java hay controles de límites que evitan este tipo de acceso.
...
> R:Es mejor porque los tests permiten comprobar automáticamente si el programa se comporta como debería y ayudan a encontrar errores que pueden no ser evidentes solamente mirando el código.
...
> R:Porque el bug sumaba solamente el precio del producto sin multiplicarlo por la cantidad. Cuando la cantidad era 1, precio * 1 daba el mismo resultado que usar solamente el precio, por eso el primer test pasó.
